...
| `agent_service_addr`      | string \| None  | `None`         | HTTP address of an external Agent Service (e.g., 'http://host:8300'). Required when mode='service'. Start the service with: python -m areal.experimental.agent_service --agent-import-path your.Agent                                                                                                                                                                                                                                                                                                                                                                                                                    |
