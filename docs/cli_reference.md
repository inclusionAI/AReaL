...
- [ScheduleStrategy](section-schedule-strategy)
...
| `scheduling_strategy`     | [`ScheduleStrategy`](section-schedule-strategy)   | **Required**          | -                                                                                                                                                                                                                                                                                                                          |
...
| `queue_size`              | integer \| None                                 | `None`          | (Deprecated) Input/Output queue size for async rollout.                                                                                                             |
