...
| `offload_train`             | boolean                                           | `False`               | Enable training offload using torch_memory_saver: offload model and optimizer to CPU when not training to save GPU memory for inference.                                                                                                                                                                  |
