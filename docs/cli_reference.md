...
| `load_device`               | string \| None                                      | `None`                | Device for loading model weights. Set to 'cpu' for memory-efficient loading of large models (rank 0 loads weights, then broadcasts). Only effective when using FSDP engine.                                                                                                                                                                                                                                                                                  |
