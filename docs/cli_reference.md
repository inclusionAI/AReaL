...
| `use_lora`                | boolean                                        | `False`               | -                                                                                                                                                                                                                                                                                                                          |
| `lora_rank`               | integer                                        | `32`                  | lora_rank                                                                                                                                                                                                                                                                                                                  |
| `lora_alpha`              | integer                                        | `16`                  | lora alpha                                                                                                                                                                                                                                                                                                                 |
| `target_modules`          | list of string \| None                         | `None`                | lora target_modules                                                                                                                                                                                                                                                                                                        |
| `peft_type`               | string \| None                                 | `None`                | peft method type, include lora, ...                                                                                                                                                                                                                                                                                        |
