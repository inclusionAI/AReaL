...
| `scheduling_spec`         | `tuple`                                             | **Required**    | inference engine schedule specs. Can accept 1 or 2 SchedulingSpec: if 1 spec provided, it's used for both worker and engine, engine is embeded in the workerif 2 specs provided, first one is for worker, second one is for engine. |
| `scheduling_strategy`     | [`SchedulingStrategy`](section-scheduling-strategy) | **Required**    | -                                                                                                                                                                                                                                   |
