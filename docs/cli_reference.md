...
| `decode_log_interval`                 | integer                 | `20`                | -           |
| `enable_stats_push`                   | boolean                 | `True`              | -           |
| `stats_push_address`                  | string                  | `"localhost:50051"` | -           |
| `enable_prefill_completion_stats`     | boolean                 | `True`              | -           |
| `prefill_completion_stats_batch_size` | integer                 | `1`                 | -           |
