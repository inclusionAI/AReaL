...
| `scheduling_specs`        | `tuple`                                             | **Required**          | train engine schedule specs, first is worker, second is engine                                                                                                                                                                                                                                                             |
...
| `scheduling_specs`        | `tuple`                                             | **Required**    | inference engine schedule specs, first is worker, second is engine                                                                                                  |
| `scheduling_strategy`     | [`SchedulingStrategy`](section-scheduling-strategy) | **Required**    | -                                                                                                                                                                   |
