...
| `offload_train`             | boolean                                           | `False`               | Enable training offload: offload model and optimizer to CPU when not training to save GPU memory for inference.                                                                                                                                                                                           |
| `offload_train_mode`        | string                                            | `"tms"`               | Offload mode: 'tms' for torch_memory_saver, 'move' for moving model/optimizer to CPU. **Choices:** `tms`, `move`                                                                                                                                                                                          |
