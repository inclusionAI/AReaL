...
| `launcher`             | [`LauncherConfig`](section-launcher)                              | **Required** | -                                                                                                                            |
| `scheduler`            | [`SchedulerConfig`](section-scheduler)                            | **Required** | -                                                                                                                            |
| `redistribute_rollout` | boolean                                                           | `False`      | Whether to redistribute rollouts across DP ranks to balance trajectories. Recommended to be True for multi-turn experiments. |
