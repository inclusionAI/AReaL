...
| Parameter                 | Type            | Default        | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ------------------------- | --------------- | -------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `api_key`                 | string          | `""`           | API key for authenticating requests to proxy and callback servers. When set, all requests must include this key in the X-API-Key header. If empty, a random key is generated at runtime for internal communication. SECURITY: Always set this in production environments.                                                                                                                                                                                                     |
