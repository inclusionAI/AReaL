...
| `fp8_direct_convert`          | boolean | `True`          | Whether to use direct FP8 conversion during weight updates. When True, FP8 parameters are directly converted without intermediate dequantization. |
