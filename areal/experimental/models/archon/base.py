...
class BaseStateDictAdapter(ABC):
    ...
    def create_peft_adapter_config(
        ...
        Args:
            lora_config: LoRA configuration object with rank, alpha, target_modules fields
        ...
        Example:
            ...
            >>> config_dict = adapter.create_peft_adapter_config(lora_cfg)
            >>> config_dict["peft_type"]
            'LORA'
        """
        ...
        config = {
            ...
            "r": lora_config.rank,
            "lora_alpha": int(lora_config.alpha),  # PEFT uses int for alpha
            "lora_dropout": 0.0,
