...
from .proxy_rollout_server import (
    SetRewardRequest as AReaLSetRewardRequest,
)
from .proxy_rollout_server import (
    StartSessionRequest as AReaLStartSessionRequest,
)
...
class OpenAIProxyClientSession:
    ...
    async def export_interactions(
        ...
        """
        from .proxy_rollout_server import deserialize_interactions
