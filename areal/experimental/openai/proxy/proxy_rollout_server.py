...
class SessionData:
    ...
    def wait_for_finish(self, timeout: float | None = None) -> bool:
        """Wait for session to finish. Returns True if finished, False if timeout."""
...
def end_session(session_id: str):
    ...
    _session_cache[session_id].finish()
