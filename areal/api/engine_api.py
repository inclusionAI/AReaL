...
class InferenceEngine(abc.ABC):
    ...
    def submit(
        ...
        should_accept : Callable[[Dict[str, Any]], bool] | str, optional
            A function or module path to a function for dynamic trajectory filtering.
            Can be:

            - A callable that takes a trajectory dict and returns bool
            - A string module path like "my_module.my_filter_fn" (will be imported)

            By default None (accept all trajectories).
        """
        raise NotImplementedError()
