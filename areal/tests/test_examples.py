...
async def run_example(
    ...
    *additional_args,
    ...
    Args:
        ...
        single_controller: If True, run in single-controller mode (direct script execution)
...
@pytest.mark.parametrize(
    ...
    [("sglang:d1+megatron:d1", False), ("sglang:d1+megatron:d1", True)],
)
@pytest.mark.multi_gpu
@pytest.mark.ci
...
@pytest.mark.parametrize(
    "alloc_mode,single_controller",
    [("fsdp:d1", False), ("megatron:d1", False), ("fsdp:d1", True)],
)
@pytest.mark.gpu
@pytest.mark.ci
