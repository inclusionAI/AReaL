...
async def test_single_turn_rollout(openai_client):
    ...
    completions = openai_client.export_interactions()
...
async def test_multi_round_conversation_concat_style_export(openai_client):
    ...
    openai_client._cache.export_style = "concat"
    # Base conversation
    base = [
        {"role": "system", "content": "You are a helpful assistant."},
    ...
    leaf_completions = openai_client.export_interactions()
    all_completions = openai_client._cache
