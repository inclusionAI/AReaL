...
5. No source file under areal/experimental/scaffolding/ contains a live
...
class TestNoTensorRTLLMDependency:
    ...
    def test_no_live_tensorrt_llm_imports_in_source(self):
        ...
        """
        scaffolding_root = (
            Path(__file__).resolve().parents[3] / "experimental" / "scaffolding"
        )
        violations = []
...
class TestCoreImports:
    ...
    def test_core_init_imports(self):
        ...
        from areal.experimental.scaffolding.core import (  # noqa: F401
            AssistantMessage,
            BestOfNController,
            ChatTask,
            Controller,
    ...
    def test_compat_reexports_match_core(self):
        ...
        from areal.experimental.scaffolding import _compat, core
    ...
    def test_core_submodule_imports(self):
        ...
        import areal.experimental.scaffolding.core.controller  # noqa: F401
        import areal.experimental.scaffolding.core.math_utils  # noqa: F401
        import areal.experimental.scaffolding.core.result  # noqa: F401
        import areal.experimental.scaffolding.core.scaffolding_llm  # noqa: F401
        import areal.experimental.scaffolding.core.task  # noqa: F401
        import areal.experimental.scaffolding.core.task_collection  # noqa: F401
        import areal.experimental.scaffolding.core.worker  # noqa: F401
...
class TestTask:
    ...
    def test_task_creation(self):
        from areal.experimental.scaffolding.core.task import Task
    ...
    def test_generation_task_create_from_prompt(self):
        from areal.experimental.scaffolding.core.task import GenerationTask
    ...
    def test_role_message_str_repr(self):
        from areal.experimental.scaffolding.core.task import UserMessage
    ...
    def test_role_message_from_dict(self):
        from areal.experimental.scaffolding.core.task import RoleMessage
    ...
    def test_assistant_message_with_reasoning(self):
        from areal.experimental.scaffolding.core.task import AssistantMessage
    ...
    def test_openai_tool_description(self):
        from areal.experimental.scaffolding.core.task import OpenAIToolDescription
    ...
    def test_task_status_values(self):
        from areal.experimental.scaffolding.core.task import TaskStatus
...
class TestController:
    ...
    def test_controller_is_abstract(self):
        from areal.experimental.scaffolding.core.controller import Controller
...
class TestWorker:
    ...
    def test_worker_is_abstract(self):
        from areal.experimental.scaffolding.core.worker import Worker
    ...
    async def test_worker_unsupported_task(self):
        from areal.experimental.scaffolding.core.task import Task, TaskStatus
        from areal.experimental.scaffolding.core.worker import Worker
    ...
    def test_is_deterministic_mode(self):
        from areal.experimental.scaffolding.core.worker import is_deterministic_mode
...
class TestResult:
    ...
    def test_scaffolding_result_set_output_none(self):
        from areal.experimental.scaffolding.core.result import ScaffoldingResult
...
class TestTaskCollection:
    ...
    def test_task_collection_base(self):
        from areal.experimental.scaffolding.core.task_collection import TaskCollection
...
class TestMathUtils:
    ...
    def test_extract_answer_from_boxed_simple(self):
        from areal.experimental.scaffolding.core.math_utils import (
            extract_answer_from_boxed,
        )
...
class TestWrapperImports:
    ...
    def test_compat_module_imports(self):
        from areal.experimental.scaffolding._compat import (  # noqa: F401
            AssistantMessage,
            BestOfNController,
            ChatTask,
            Controller,
    ...
    def test_controllers_module_imports(self):
        from areal.experimental.scaffolding.controllers import (  # noqa: F401
            ChatTracer,
    ...
    def test_task_module_imports(self):
        from areal.experimental.scaffolding.task import (  # noqa: F401
            ChatRewardTask,
            RLVRRewardTask,
            TraceGenerationTask,
        )
    ...
    def test_worker_module_imports(self):
        from areal.experimental.scaffolding.worker import (  # noqa: F401
            CreateWorkerFromEngine,
            SGLangWorker,
        )

    def test_workflow_module_imports(self):
        from areal.experimental.scaffolding.workflow import (
            ScaffoldingWorkflow,  # noqa: F401
        )

    def test_top_level_package_imports(self):
        from areal.experimental.scaffolding import (  # noqa: F401
            ChatRewardTask,
            ChatTracer,
            CreateWorkerFromEngine,
            PipelineTrajectoryMaker,
...
class TestCrossModuleIntegration:
    ...
    def test_sglang_worker_inherits_from_core_openai_worker(self):
        from areal.experimental.scaffolding.core.worker import OpenaiWorker
    ...
    def test_rlvr_reward_controller_inherits_from_core_controller(self):
        from areal.experimental.scaffolding.controllers import RLVRRewardController
        from areal.experimental.scaffolding.core.controller import Controller

        assert issubclass(RLVRRewardController, Controller)

    def test_pipeline_trajectory_maker_inherits_from_core_controller(self):
        from areal.experimental.scaffolding.controllers import PipelineTrajectoryMaker
        from areal.experimental.scaffolding.core.controller import Controller
    ...
    def test_compat_classes_are_same_as_core_classes(self):
        ...
        from areal.experimental.scaffolding._compat import Task as CompatTask
        from areal.experimental.scaffolding._compat import Worker as CompatWorker
        from areal.experimental.scaffolding.core.controller import Controller
        from areal.experimental.scaffolding.core.scaffolding_llm import ScaffoldingLlm
        from areal.experimental.scaffolding.core.task import GenerationTask, Task
        from areal.experimental.scaffolding.core.worker import Worker
