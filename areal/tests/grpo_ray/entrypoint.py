...
from areal.api.alloc_mode import AllocationMode, FinetuneSpec, WeightUpdateMeta
...
def main() -> None:
    ...
    if dist.get_rank() == 0:
        success_file = os.path.join(config.cluster.fileroot, "success.txt")
        with open(success_file, "w") as f:
            f.write(f"Training completed successfully with {global_step} steps\n")
