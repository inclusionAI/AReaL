...
log_config = {
    ...
    "loggers": {
        ...
        # These are re-applied on every getLogger() call via dictConfig.
        ...
        "aiohttp.access": {"handlers": [], "level": "WARNING", "propagate": False},
        "aiohttp.server": {"handlers": [], "level": "WARNING", "propagate": False},
...
# Loggers that are forcibly suppressed to WARNING in entrypoints where
# uvicorn/Flask reconfigure logging AFTER dictConfig (e.g., __main__.py).
_HTTP_LOGGERS = (
    "uvicorn",
    "uvicorn.access",
    "uvicorn.error",
