...
from areal.controller.rollout_buffer import RolloutBuffer
...
from areal.utils.util import clear_dir, custom_collate_fn
            ...
            for step in range(start_step, step_num):
                ...
                with (
                    ...
                    with (
                        ...
                        logger.info(
                            f"pop {len(batch_data)} samples from rollout buffer"
                        )
                            ...
                            with stats_tracker.record_timing("partial_rollout"):
                                ...
                                stats_tracker.scalar(
                                    **{
                                        ...
                                        "abort_query_ratio": abort_query_num
                                        / batch_len,
                                    }
                                )
