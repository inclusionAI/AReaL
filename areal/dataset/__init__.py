...
VALID_DATASETS = ["gsm8k", "clevr_count_70k", "geometry3k", "OpenR1"]
...
def get_custom_dataset(
    ...
    **kwargs,
    ...
    elif "openr1" in path.lower() and type == "sft":
        from .OpenR1 import get_openr1_sft_dataset

        return get_openr1_sft_dataset(
            path=path,
            split=split,
            tokenizer=tokenizer,
            rank=rank,
    ...
    elif "openr1" in path.lower() and type == "rl":
        from .OpenR1 import get_openr1_rl_dataset

        return get_openr1_rl_dataset(
            path=path,
            split=split,
            tokenizer=tokenizer,
            rank=rank,
