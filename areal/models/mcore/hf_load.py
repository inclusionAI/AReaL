...
def _te_fp8_to_pytorch_fp8(
    ...
    This function extracts the data and scale_inv from a TE Float8BlockwiseQTensor
    ...
    # For Float8BlockwiseQTensor, extract rowwise_data and rowwise_scale_inv
    if hasattr(te_fp8_tensor, "_rowwise_data") and hasattr(
        te_fp8_tensor, "_rowwise_scale_inv"
    ):
        ...
        # Fallback for non-blockwise tensors
        data_uint8 = te_fp8_tensor._data
        pytorch_fp8_tensor = data_uint8.view(torch.float8_e4m3fn)
        scale_inv = te_fp8_tensor._scale_inv.clone()
