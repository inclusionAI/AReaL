...
HF_ENDPOINT=http://hf-mirror.com huggingface-cli download --repo-type dataset --resume-download hiyouga/geometry3k --local-dir /storage/openpsi/data/geometry3k 
