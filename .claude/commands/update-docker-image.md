...
description: Update the Dockerfile given package versions, and use GitHub CI to build and test the new image.
argument-hint: <package-versions>
---

## Usage

```
/update-docker-image $ARGUMENTS
```
