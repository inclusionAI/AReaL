...
- `areal/engine/core.py` - Shared training utilities: `aggregate_eval_losses()`,
  `compute_total_loss_weight()`, `reorder_and_pad_outputs()`
- `areal/utils/functional.py` - `gather_logprobs()`, `gather_logprobs_entropy()` for
