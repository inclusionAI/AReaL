...
base_model="/storage/openpsi/models/Qwen__Qwen2.5-32B-Instruct"
lr=1e-5
min_lr=0
epochs=1
...
torchrun --nproc-per-node ${gpu_count} --master_port 12345 \
    ...
    --train_file_path="/storage/openpsi/users/zzy/Multiverse_original/zzy_train_8_times" \
    ...
    --adam_beta1=0.9 \
    --adam_beta2=0.95 \
    --output_dir="ckpts/Multiverse-Qwen-A3B-multiverse-data-${uid}" \
