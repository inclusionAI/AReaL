...
SEGMENT_STYLES: dict[str, dict[str, Any]] = {
    ...
    "traj": {"label": "Trajectory", "color": "#9caf88"}, # Sage Green 
    "user_generate": {"label": "User Generate", "color": "#f5f1e6"}, # Cream
    "agent_generate": {"label": "Agent Generate", "color": "#cc8b6f"}, # Terracotta
}
...
HISTOGRAM_METRICS: dict[str, dict[str, Any]] = {
    ...
    "traj_s": {"label": "Trajectory duration", "color": "#9caf88"}, # Sage Green 
    "user_generate_s": {"label": "User generation duration", "color": "#f5f1e6"}, # Cream
    "agent_generate_s": {"label": "Agent generation duration", "color": "#cc8b6f"}, # Terracotta
}
