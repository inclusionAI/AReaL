...
def create_rl_dataset(data_paths, data_config, tokenizer, processor):
    ...
    from areal.dataset.rl_dataset import RLHFDataset
...
def main(args):
    ...
    train_dataset = create_rl_dataset(
        data_paths=config.train_dataset.path,
        data_config=config.train_dataset,
        tokenizer=tokenizer,
        processor=processor,
    )
    valid_dataset = create_rl_dataset(
        data_paths=config.valid_dataset.path,
        data_config=config.valid_dataset,
        tokenizer=tokenizer,
        processor=processor,
    )
