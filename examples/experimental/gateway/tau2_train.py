"""Tau2 agent training using the GatewayRolloutController.

Functionally identical to ``examples/tau2/train.py`` — the gateway
rollout controller is activated by setting ``rollout.use_gateway=true``
in the YAML config.
"""
...
logger = logging.getLogger("Tau2GatewayTrain")
...
def main(args):
    ...
    with PPOTrainer(
        ...
        trainer.train(
            ...
            dynamic_filter_fn="examples.experimental.gateway.tau2_train.group_filter",
        )
