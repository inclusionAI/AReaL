...
CVRT_WARNING = "This parameter has no exact mapping in arealite"
FEAT_WARNING = (
    "This parameter is not supported in arealite, but should be supported in the future"
)
...
class Converter(abc.ABC):
    ...
    def parse(self) -> dict:
        """
        Parse the arguments from other framework format to a arealite config.
        """
        pass
    ...
    def get_lite_template(self, template_path: str):
        """
        Load the arealite template from the specified file.
        """
...
class OpenRLHFConverter(Converter):
    ...
    ARG_MAP = {
        ...
        "async_train": ArgSpec(
            "async_training", bool
        ),  # TODO: convert arealite offpolicyness > 0
        # Checkpoints
        ...
        ),  # TODO: convert to arealite's cluster.fileroot
        ...
        ),  # should be mapped to arealite's scheduler
    ...
    def __init__(
        ...
        Args:
            ...
            template_path (str): The path to the arealite template file.
...
class AReaLConverter(Converter):
    """
    Convert AReaL arguments to AReaLite arguments.
    """
    ...
    ARG_MAP = {
        ...
        # Megatron not implemented in arealite
...
def parse_args():
    parser = argparse.ArgumentParser(description="Convert to arealite YAML config")
    parser.add_argument(
        "--convert_src",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="path to the arealite template file",
    )
    parser.add_argument(
        "--output_path",
        type=str,
...
def main():
    """
    Usage:
    - OpenRLHF: python arealite/utils/convert.py --convert_src OpenRLHF --src_script_path <path_to_script> --template_path <path_to_template_alite_yaml> --output_path <output_yaml>
    - AReaL:    python arealite/utils/convert.py --convert_srv AReaL --src_config_path <path_to_areal_yaml> --template_path <path_to_template_alite_yaml> --output_path <output_yaml>
    """
    args = parse_args()
    ...
    print(f"Converted arealite config saved to {args.output_path}")
    # print(yaml_str)
