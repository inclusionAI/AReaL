...
The Docker images are available on Docker Hub at [lmsysorg/sglang](<>), built from the
[Dockerfile](https://github.com/sgl-project/sglang/tree/main/docker). Replace `<secret>`
below with your HuggingFace Hub
