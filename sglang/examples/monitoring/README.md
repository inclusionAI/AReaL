...
This directory contains a ready-to-use monitoring setup for SGLang using Prometheus and
Grafana.
...
4. The SGLang dashboard will be automatically available in the "SGLang Monitoring"
   folder.
...
1. Ensure no other services are using ports 9090 and 3000:
...
1. Verify the datasource configuration in Grafana
1. Check that your SGLang server is properly exposing metrics
