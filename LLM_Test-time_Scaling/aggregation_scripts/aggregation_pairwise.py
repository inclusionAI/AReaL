...
Usage:
    python -m aggregation_scripts.aggregation_pairwise \
        ...
        --output-dir aggregation_experiments/imobench_random/4_traj_low_effort_4exps \
        --solutions-per-exp 4 \
        --num-exps 4 \
...
async def run_aggregation_experiment(
    ...
    # 6. Pairwise comparison (each pair compared once with random order)
    ...
    # Only use pairwise_comparison strategy
    strategies = {"pairwise_comparison": strategies["pairwise_comparison"]}
