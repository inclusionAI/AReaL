...
# 4B model, mixed_rl_v2 dataset (no mapqa)

WORKSPACE=${WORKSPACE:-/storage/openpsi/data/lcy_image_edit/mixed_rl_v2}
model_name=${MODEL_PATH:-/storage/openpsi/models/lcy_image_edit/sft_workspace/qwen3vl4b-thinking-5ds-v2-0424-ct65536/checkpoint-280}

train_data="$WORKSPACE/train.parquet"
val_data="$WORKSPACE/val.parquet"
run_name="4b-at-gigpo-v2-uniform-n8"
rl_alg=gigpo
