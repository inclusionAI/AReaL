...
def test_gemini_custom_api_base_tool_call() -> None:
    ...
    save_dir = Path("./gemini_custom_api_test")
    ...
    # Use chat_completions API mode for OpenAI-compatible endpoint
    ...
    task = OpenAICompatibleVisionQATask(
        task_id="gemini_custom_api_test",
    ...
    logger.info("Gemini custom API base test completed successfully.")


if __name__ == "__main__":
    print("Gemini Custom API Base Tool Call Test")
    print("=" * 50)
    print("\nEnvironment variables:")
    print("  GEMINI_API_KEY    - Required: API key for authentication")
    print("  GEMINI_API_BASE   - Optional: Custom OpenAI-compatible API base URL")
    print("  GEMINI_MODEL_NAME - Optional: Model name (default: gemini-2.5-flash)")
    print("\nRunning test...")
    test_gemini_custom_api_base_tool_call()
