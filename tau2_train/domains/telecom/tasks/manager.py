...
from tau2_train.data_model.tasks import EnvAssertion, EnvFunctionCall, Task
from tau2_train.domains.telecom.environment import TelecomEnvironment, get_environment
from tau2_train.environment.environment import Environment
from tau2_train.utils import DATA_DIR
...
class TaskManager:
    ...
    def verify_task(self, task: Task):
        ...
        for tau2_train.domains.telecom.environment import get_environment

        print("Verifying task: ", task.id)

        # telecom_env = registry.get_env_constructor("telecom")()
        telecom_env = get_environment()
