...
class Orchestrator:
    ...
    async def step(self):
        ...
        if self.from_role in [Role.AGENT, Role.ENV] and self.to_role == Role.USER:
            async with perf_tracer.atrace_session_phase(self.perf_session_id, "user_generate"):
        ...
        # USER/ENV -> AGENT
            ...
            async with perf_tracer.atrace_session_phase(self.perf_session_id, "agent_generate"):
        ...
        # AGENT/USER -> ENV
            ...
            tool_msgs = []
            async with perf_tracer.atrace_session_phase(self.perf_session_id, "toolcall"):
