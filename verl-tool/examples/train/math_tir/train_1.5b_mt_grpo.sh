...
# GPU settings - use GPU 0,1,2,3,4,5
...
rl_alg=mt_grpo # MT-GRPO with turn-level credit assignment
turn_advantage_coef=1.0 # Coefficient for turn-level advantage
n_gpus_per_node=6  # Using 6 GPUs: 0,1,2,3,4,5
n_nodes=1
n=16
batch_size=126
...
run_name_postfix="acc-only-6gpu"
