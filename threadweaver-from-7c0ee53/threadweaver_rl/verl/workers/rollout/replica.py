...
class TokenOutput(BaseModel):
    token_ids: list[int]
    """Response token ids generated for the request."""
    log_probs: Optional[list[float]] = None
    """Optional per-token log probabilities when requested."""
    finish_reason: Optional[str] = None
    """Reason reported by the engine for stopping the generation (e.g., stop, length)."""
    matched_stop: Optional[int] = None
    """ID of the stop token that triggered termination, if any."""
    generated_blocks: Optional[list[dict[str, Any]]] = None
    """Structured breakdown of generated tokens grouped by generation block."""
    call_idx: Optional[int] = None
    """Index of the call in the expanded batch, if applicable."""
