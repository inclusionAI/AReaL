...
EVAL_SCRIPT="${SCRIPT_DIR}/src/simple_eval_pause_close_parallel_thinksolve.py"
...
csv_path = os.path.join(results_root, "pause_sweep_report.csv")
md_path = os.path.join(results_root, "pause_sweep_report.md")
