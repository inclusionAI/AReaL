...
model_name=/storage/openpsi/models/lcy_image_edit/sft_workspace/qwen3vl8b-thinking-chartqa-1third
...
curl -s http://$WORKER_IP:30888/health || { echo "ERROR: Tool server not reachable!"; exit 1; }
...
echo "Training finished. Tool server left running on worker."
