...
def process_results_v2(answer, solution):
    ...
    try:
        ...
        if len(extracted_answer) == 0:
            retval = 0
        elif len(extracted_solution) == 0:
            retval = 0
        elif verify(extracted_solution, extracted_answer):
            retval = 1
        else:
            retval = 0
...
def process_results_greso(answer, solution, format_score=0.1):
...
def process_results_greso_v2(answer, solution, format_score=0.1):
    from math_verify import parse, verify
