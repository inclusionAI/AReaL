...
description: Update runtime dependency versions, validate Docker build compatibility, and drive the Docker image PR workflow.
---
...
1. **Create a PR and trigger CI.** Load the `create-pr` skill to create the PR, then
