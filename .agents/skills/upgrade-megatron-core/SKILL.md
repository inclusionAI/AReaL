...
description: Upgrade Megatron-Core in AReaL by auditing affected APIs, cross-referencing upstream sources, and updating call sites.
---
...
This skill requires upstream source repos to cross-reference API signatures.
