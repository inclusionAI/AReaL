...
@sgl.function
def main_generation(s, problem: str, context: str = "", max_tokens: int = 32768):
...
def process_single_problem(problem_text: str, problem_idx: int, output_dir: str, 
                          ...
                          port: int = 30000, num_threads: int = 8):
...
def main(output_dir: str = None, use_existing_server: bool = False, 
         ...
         jsonl_path: str = None, num_threads: int = 8):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num-threads", type=int, default=8,
                       help="Number of parallel threads to launch (default: 8)")
